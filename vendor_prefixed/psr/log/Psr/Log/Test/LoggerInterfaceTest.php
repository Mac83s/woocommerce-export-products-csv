...
namespace WoocommerceExportProductsCSVVendor\Psr\Log\Test;

use Psr\Log\LoggerInterface;
use Psr\Log\LogLevel;
use WoocommerceExportProductsCSVVendor\PHPUnit\Framework\TestCase;
/**
 ...
 */
abstract class LoggerInterfaceTest extends \WoocommerceExportProductsCSVVendor\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertInstanceOf('WoocommerceExportProductsCSVVendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WoocommerceExportProductsCSVVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WoocommerceExportProductsCSVVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
    ...
    public function testContextCanContainAnything()
    {
        ...
        \fclose($closed);
        $context = array('bool' => \true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => array('with object' => new \WoocommerceExportProductsCSVVendor\Psr\Log\Test\DummyTest()), 'object' => new \DateTime(), 'resource' => \fopen('php://memory', 'r'), 'closed' => $closed);
