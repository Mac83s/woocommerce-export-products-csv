...
if (!\class_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Tracker_Sender_Wordpress_To_WPDesk')) {
    class WPDesk_Tracker_Sender_Wordpress_To_WPDesk implements \WPDesk_Tracker_Sender
    {
        ...
        public function send_payload(array $payload)
        {
            ...
            if ($response instanceof \WP_Error) {
                throw new \WoocommerceExportProductsCSVVendor\WPDesk_Tracker_Sender_Exception_WpError('Payload send error', $response);
            } else {
                return $response;
            }
        }
