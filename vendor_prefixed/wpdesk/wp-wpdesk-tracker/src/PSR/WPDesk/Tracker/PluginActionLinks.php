 ...
 */
class PluginActionLinks implements \WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
    ...
    private function append_opt_link($links)
    {
        ...
        $tracker_consent = new \WoocommerceExportProductsCSVVendor\WPDesk_Tracker_Persistence_Consent();
        $plugin_links = [];
