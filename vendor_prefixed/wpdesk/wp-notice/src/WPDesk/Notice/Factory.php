...
class Factory
{
    ...
    {
        return new \WoocommerceExportProductsCSVVendor\WPDesk\Notice\Notice($noticeContent, $noticeType, $isDismissible, $priority);
    }
    /**
    ...
    {
        return new \WoocommerceExportProductsCSVVendor\WPDesk\Notice\PermanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
