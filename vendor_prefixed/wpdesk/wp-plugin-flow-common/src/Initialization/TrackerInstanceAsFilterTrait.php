...
use WoocommerceExportProductsCSVVendor\WPDesk\Tracker\OptInOptOut;
/**
...
trait TrackerInstanceAsFilterTrait
{
    ...
    private function prepare_tracker_action()
    {
        ...
        \add_filter($this->get_tracker_action_name(), function ($tracker_instance) {
            ...
            if (\apply_filters('wpdesk_can_start_tracker', \true, $this->plugin_info)) {
                $tracker_factory = new \WoocommerceExportProductsCSVVendor\WPDesk_Tracker_Factory_Prefixed();
    ...
    private function register_tracker_ui_extensions()
    {
        ...
        $tracker_ui = new \WoocommerceExportProductsCSVVendor\WPDesk\Tracker\OptInOptOut($this->plugin_info->get_plugin_file_name(), $this->plugin_info->get_plugin_slug(), $shop_url, $this->plugin_info->get_plugin_name());
