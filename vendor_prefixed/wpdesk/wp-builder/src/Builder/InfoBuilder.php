 ...
 */
class InfoBuilder extends \WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\WoocommerceExportProductsCSVVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
