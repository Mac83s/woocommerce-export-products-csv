...
namespace WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Builder;
...
use WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\WoocommerceExportProductsCSVVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
