...
trait HookableParent
{
    ...
    {
        if ($hookable_object instanceof \WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant) {
    ...
    protected function hooks_on_hookable_objects()
    {
        ...
        foreach ($this->hookable_objects as $hookable_object) {
            if ($hookable_object instanceof \WoocommerceExportProductsCSVVendor\WPDesk\PluginBuilder\Plugin\Conditional) {
