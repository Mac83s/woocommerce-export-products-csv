...
if (!\interface_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \WoocommerceExportProductsCSVVendor\WPDesk_Translatable, \WoocommerceExportProductsCSVVendor\WPDesk_Buildable, \WoocommerceExportProductsCSVVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
