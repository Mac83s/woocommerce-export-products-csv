...
if (!\class_exists('WoocommerceExportProductsCSVVendor\\Basic_Requirement_Checker')) {
    require_once __DIR__ . '/Basic_Requirement_Checker.php';
}
if (!\class_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
...
class WPDesk_Basic_Requirement_Checker_Factory
{
    ...
    {
        return new \WoocommerceExportProductsCSVVendor\WPDesk_Basic_Requirement_Checker($plugin_file, $plugin_name, $text_domain, null, null);
    }
    /**
    ...
    {
        $requirements_checker = new \WoocommerceExportProductsCSVVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp'], (bool) \wp_using_ext_object_cache());
