...
if (!\class_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \WoocommerceExportProductsCSVVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
