...
if (!\interface_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('WoocommerceExportProductsCSVVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \WoocommerceExportProductsCSVVendor\WPDesk_Requirement_Checker
    {
